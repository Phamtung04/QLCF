                    ...
                    <>
                                    ...
                                    <React.Fragment key={item.rid}>
                                        ...
                                        >
                                            ...
                                            <Box sx={{ flex: '1 1 auto', minWidth: 0 }}>
                                                ...
                                                <Typography sx={{ fontSize: '18px', fontWeight: '500', mb: 1 }}>{item.name}</Typography>
                                                <Box
                                                    onClick={() => handleOpenAddDrink(item)}
                                            ...
                                            >
                                                <ButtonBase
                                                    ...
                                                    sx={{
                                                        borderRadius: '50px',
                                                        color: '#FFC20E',
                                                        minWidth: '35px', // Ensures buttons are uniformly sized
                                                        height: '35px' // Increase padding to increase button size
                                                    }}
                                                >
                        ...
                        <DialogActions
                            sx={{
                                display: 'flex',
                                flexDirection: 'column',
                                alignItems: 'center', // Canh giữa các phần tử theo trục ngang
                            ...
                            {orderItems.length !== 0 ? (
                                <ButtonBase
                                    ...
                                    sx={{
                                        ...
                                        display: 'flex',
                                        justifyContent: 'center', // Canh giữa nội dung bên trong ButtonBase
                                        alignItems: 'center' // Canh giữa nội dung bên trong ButtonBase
                                    }}
                                >
                                    {isLoading ? (
